...
def lerp_pose(p1: Pose2d, p2: Pose2d, n1: float) -> Pose2d:
    ...
    rotation_x = p1.rotation().cos() * n2 + p2.rotation().cos() * n1
    rotation_y = p1.rotation().sin() * n2 + p2.rotation().sin() * n1
    return Pose2d(translation, Rotation2d(rotation_x, rotation_y))
