    ...
    def __init__(self) -> None:
        super().__init__(
            [
                ...
                Waypoint(-2.1, -2.6, Rotation2d.fromDegrees(-200)),
                Waypoint(
                    -3.21, -2.1, Rotation2d.fromDegrees(-200), WaypointType.SHOOT
                ),  # 2
                Waypoint(
                    -6.95, -2.8, Rotation2d.fromDegrees(-136), WaypointType.PICKUP
                ),  # 4
                Waypoint(
